...
/*
  ...
  */
export const hexMd5 = function (s) { return binl2hex(coreMd5(str2binl(s), s.length * chrsz)) }
export const b64_md5 = function (s) { return binl2b64(coreMd5(str2binl(s), s.length * chrsz)) }
export const str_md5 = function (s) { return binl2str(coreMd5(str2binl(s), s.length * chrsz)) }
